...
# -dontwarn和-keep 结合使用，意思是保持com.xx.xx.**这个包里面的所有类和所有方法而不混淆
...
-keep public class com.tobot.device.UsbPower {
    public <fields>;
    public <methods>;
}
# 忽略混淆json使用到的bean类
-keep public class com.tobot.launcher.entity.OperatorBean { *;}
-keep public class com.tobot.launcher.entity.LoginInfo { *;}
-keep public class com.tobot.launcher.entity.WaringInfo { *;}